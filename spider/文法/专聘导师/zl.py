...
base = 'https://wfxy.buct.edu.cn/jzds/list.htm'
headers = {
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36'}
root_url = "https://wfxy.buct.edu.cn/jzds/list.htm"
urls = UrlManager()
...
def craw(url, index):
    print("ready")
    print(url)
    if (url != "https://wfxy.buct.edu.cn/jzds/list.htm"):
            ...
            datarow = ['文法/专聘导师/pic/'+name+'.jpg',name, content_]
                ...
                if re_url is not None:
                    ...
                    if  (re_url != "<img src=""/>"):
                        ...
                        if not (image is None ):
                                ...
                                with open('文法/专聘导师/pic/{}.jpg'.format(name), 'wb') as f:
                                    f.write(image)
                                excel.write(index, 0, '文法/专聘导师/pic' + name + '.jpg')
