...
base = 'https://chemistry.buct.edu.cn/1689/list.htm'
headers = {
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36'}
root_url = "https://chemistry.buct.edu.cn/1689/list.htm"
urls = UrlManager()
excelfile = xlsxwriter.Workbook("化学学院/1.xlsx")
...
def first():
    ...
    lists = soup.find("div", 'teacher clearfix').find_all("a")  
    for l in lists:
        print(l)
        h = l['href']
        num = num + 1
...
def craw(url, index):
    print("ready")
    print(url)
    if (url != "https://chemistry.buct.edu.cn/1989/list.htm")&(url != "https://chemistry.buct.edu.cn/1689/list.htm")&(url != "https://chemistry.buct.edu.cn/1990/list.htm")&(url != "https://chemistry.buct.edu.cn/2018/0314/c1955a23049/page.htm")&(url != "https://chemistry.buct.edu.cn/2019/0311/c1951a23906/page.htm")&(url != "https://chemistry.buct.edu.cn/2016/0928/c1955a23052/page.htm"):
        rd = requests.get(url=url, headers=headers)
        if rd.status_code == 200:
            rd.encoding = 'utf-8'
            soup = BeautifulSoup(rd.text, "html.parser")
            try:
                name = soup.find("div", class_='rt_tit').find("h1").get_text()
                print(name)
            except:
                name = "error"
            #print(name)
            ...
            datarow = ['pic/'+name+'.jpg',name, content_]
                ...
                if re_url is not None:
                    ...
                    if  (re_url != "<img src=""/>"):
                        ...
                        if not (image is None ):
                                ...
                                with open('化学学院/pic/{}.jpg'.format(name), 'wb') as f:
                                    f.write(image)
                                excel.write(index, 0, '化学学院/pic' + name + '.jpg')
